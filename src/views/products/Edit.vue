<script setup>
import {useEditProductComposable} from "@/composables/product/edit_composable.js";
...
const {
          ...
          removeImage,
          imageHandler
      } = useEditProductComposable(props);
</script>
                ...
                <v-row>
                    ...
                    <v-col cols="6">
                        <div>
                            ...
                            <img v-if="data.imagePreview" :src="data.imageUrl" id="image-preview" alt="image_preview"
                                 class="mt-n5 mb-5 ml-10"
                                 style="width: 10rem;">
                        </div>
